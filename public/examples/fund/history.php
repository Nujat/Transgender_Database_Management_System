...
<body>
	...
	$query = 'select acc_no "Account No.",branch_name "Branch Name",bank_name "Bank Name",deduct_money "Deduct Money",remaining_money "Remaining Money",deduct_date "Deduct Date" from test.fund_history';
