...
<body>
	...
	$query = 'select ACT_NO "Law No",ACT_TYPE "Act Type",ACT_DESCRIPTION "Description",LAW_PUBLISHED_DATE "Law publish date",PUNISHMENT "Punishment" from test.law_police_jail';
